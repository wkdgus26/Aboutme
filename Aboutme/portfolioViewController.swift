...
var items = ["C#, Unity를 이용한 방치형 2D 게임", "C#, Unity를 이용한 VR 슛팅 게임", "C#, Unity를 이용한 VR Mini Game","Php, 코드이그니터를 이용한 레스토랑 예약페이지 만들기", "php를 이용한 남성 의류 쇼핑몰 만들기", "스위프트를 이용해 자기소개 앱만들기"]
